...
def run_test_generate_points_on_circle():
    ...
    expected = [rg.Point(6.0, 28.0),  # All numbers are approximate.
                rg.Point(-14.0, 62.6),
                rg.Point(-54.0, 62.6),
                rg.Point(-74.0, 28.0),
                rg.Point(-54.0, -6.6),
                rg.Point(14.0, -6.6)]
    circle = rg.Circle(rg.Point(-34, 28), 40)
    answer = generate_points_on_circle(circle, 6)
...
def run_test_draw_points_on_circle():
    ...
    title = 'Test 4: 80 purple points on a black circle'
    window = rg.RoseWindow(400, 400, title)
...
def run_test_polygon():
    ...
    title = 'POLYGON test 3: 4 segments, black lines on line green circle'
...
def run_test_fancy_polygon():
    ...
    title = ('FANCY POLYGON test 4:  30 blues lines on lime green circle,'
             + ' hops = 5.')
    window = rg.RoseWindow(500, 500, title)
